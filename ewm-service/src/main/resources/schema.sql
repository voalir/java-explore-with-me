...
CREATE UNIQUE INDEX IF NOT EXISTS categories_id_index ON categories USING btree (id);
...
CREATE UNIQUE INDEX IF NOT EXISTS events_id_index ON events USING btree (id);
...
CREATE UNIQUE INDEX IF NOT EXISTS requests_id_index ON requests USING btree (id);
...
CREATE UNIQUE INDEX IF NOT EXISTS compilations_events_unique_index
    ON public.compilations_events USING btree (compilation_id, event_id);